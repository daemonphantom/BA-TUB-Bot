...
from . import quiz, forum, group_building, links, pdf, videos
...
def crawl_course(driver, course_id: str):
    ...
    crawler_map = {
        "forums": lambda driver: forum.crawl(driver, course_path / "forums"),
        "quizzes": quiz,
        "groups": group_building,
        "links": links,
        "pdf": lambda driver: pdf.crawl(driver, course_path / "pdf"),
        "videos": lambda driver: videos.crawl(driver, course_path / "videos")
    }
...
if __name__ == '__main__':
    ...
    try:
        ...
        test_course_id = '30422'  # Replace with an actual course ID from your crawl_this_course_id.json
